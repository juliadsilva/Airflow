...
dag = DAG('trigger_group', description = "Trigger", schedule_interval=None, start_date = datetime(2023,3,4), catchup=False)
...
task9 = BashOperator(task_id = "tsk9", bash_command="sleep 5", dag=dag, task_group=tsk_group, trigger_rule = 'one_failed')
