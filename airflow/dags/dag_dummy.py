...
dag = DAG('dag_dummy', description = "Dummy", schedule_interval=None, start_date = datetime(2023,3,4), catchup=False)
...
taskdummy = DummyOperator(task_id = "dummy", dag=dag)

[task1,task2,task3] >> taskdummy

taskdummy >> [task4,task5]
